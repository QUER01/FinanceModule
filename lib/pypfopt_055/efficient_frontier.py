...
class EfficientFrontier(base_optimizer.BaseScipyOptimizer):
    ...
    def __init__(self, expected_returns, cov_matrix, cov_matrix_unadjusted=None,cov_type = None, weight_bounds=(0, 1), gamma=0):
        """
        ...
        self.cov_matrix_unadjusted = cov_matrix_unadjusted
    ...
    def portfolio_performance(self, verbose=False, risk_free_rate=0.02):
        ...
        if self.cov_type == 'adjusted':
            return base_optimizer.portfolio_performance(
                self.expected_returns,
                self.cov_matrix_unadjusted,
                self.weights,
                verbose,
                risk_free_rate,
            )
